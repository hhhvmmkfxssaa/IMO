...
token = "]]..1928435286:AAE7Z8IHXq_bapvxP_fSldj88_GTGv2hnR8..[["
SUDO = ]]..@TTITITl..[[  
UserName = "]]..@TTITITl..[["
...
local RunBot = io.open("TREND", 'w')
RunBot:write([[
#!/usr/bin/env bash
cd $HOME/TREND
token="]]..database:get(Server_Done.."Token_Write")..[["
rm -fr TREND.lua
wget "https://raw.githubusercontent.com/TrendTeam1/TREND/main/TREND.lua"
while(true) do
rm -fr ../.telegram-cli
...
while(true) do
rm -fr ../.telegram-cli
screen -S TREND -X kill
screen -S TREND ./TREND
done
]])
RunTs:close()
end
